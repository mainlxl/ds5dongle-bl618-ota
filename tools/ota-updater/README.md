...
GitHub Actions 编译：打开仓库的 **Actions → OTA Updater Build (Manual) → Run workflow**，可填写要编译的分支、tag 或 commit；留空使用 `master`。每次手动运行会生成 Windows 和 macOS Apple Silicon 两个 artifact，并附 SHA256 文件。
